...
export const getDialogs = (params = { append: false, limit: 30 }) => (dispatch, getState) => {
    ...
    return QB.chat
        ...
        .catch(e => {
            showError("Falha ao obter conversas", e.message);
...
export const createDialog = params => dispatch => {
    ...
    return QB.chat
        ...
        .catch(e => {
            showError("Falha ao criar conversa", e.message);
...
export const updateDialog = params => dispatch => {
    ...
    return QB.chat
        ...
        .catch(e => {
            showError("Falha ao atualizar conversa", e.message);
...
export const leaveDialog = dialogId => dispatch => {
    ...
    return QB.chat
        ...
        .catch(e => {
            showError("Falha ao sair da conversa", e.message);
...
export const deleteDialog = dialogId => dispatch => {
    ...
    return QB.chat
        ...
        .catch(e => {
            ...
            showError("Falha ao remover conversa", e.message);
        });
};
