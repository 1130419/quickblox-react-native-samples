...
export const setupPushNotifications = () => {
    ...
    if (Platform.OS === "android") {
        if (gServices && gServices.project_info && gServices.project_info.project_number) {
    ...
    PushNotification.configure({
        ...
        onRegister: function({ token }) {
            QB.subscriptions
                ...
                .catch(e => showError("Error occured while subscribing to push events", e.message));
        },
...
export const removePushSubscription = () =>
    new Promise(resolve => {
        ...
        if (udid) {
            QB.subscriptions.get().then(subscriptions => {
