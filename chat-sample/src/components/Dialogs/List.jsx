...
export default class DialogsList extends React.PureComponent {
    ...
    renderDialog = ({ item }) => {
        ...
        return <Dialog dialog={item} onPress={this.onPress} onLongPress={this.onLongPress} selectable={selectable} isSelected={isSelected} />;
    };
    ...
    render() {
        ...
        return (
            <FlatList
                ...
                refreshControl={<RefreshControl colors={[colors.primary]} onRefresh={getDialogs} refreshing={loading} tintColor={colors.primary} />}
