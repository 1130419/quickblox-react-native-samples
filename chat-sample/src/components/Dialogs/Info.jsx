        ...
        return {
            headerTitle: (
                <View style={styles.titleView}>
                    ...
                    <Text style={styles.titleSmallText}>{dialog.occupantsIds.length} participantes</Text>
                </View>
            ),
            headerRight: (
                <TouchableOpacity onPress={() => navigation.navigate("AddOccupants", { dialog })} style={styles.headerButton}>
    ...
    render() {
        ...
        return (
            <SafeAreaView style={styles.safeArea}>
                <FlatList data={data} keyExtractor={({ id }) => `${id}`} renderItem={this.renderUser} style={localStyles.list} />
            </SafeAreaView>
        );
    }
}
