...
export default class RemoteImage extends React.Component {
    ...
    shouldComponentUpdate(nextProps, nextState) {
        ...
        return source.uri !== nextProps.source.uri || loaded !== nextState.loaded;
    }
    ...
    render() {
        const imageProps = this.state.loaded
            ? this.props
            : {
                  ...this.props,
        ...
        return (
            <View>
                ...
                {this.state.loaded ? null : (
                    ...
                    >
                        <Image pointerEvents="none" resizeMode="contain" source={IMAGE} style={{ height: 50, width: 50 }} />
                    </Animated.View>
                )}
                <TouchableOpacity onLongPress={this.onLongPress} onPress={this.enlarge} style={styles.enlargeBtn} />
            </View>
        );
    }
}
