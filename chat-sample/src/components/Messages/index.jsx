...
export default class Messages extends React.PureComponent {
        ...
        return {
            headerTitle: (
                <View style={localStyles.titleView}>
                    {dialog.photo ? (
                        <Image resizeMode="center" source={{ uri: dialog.photo }} style={localStyles.dialogCircle} borderRadius={80} />
                    ) : (
            ...
            headerRight:
                dialog.type === QB.chat.DIALOG_TYPE.PUBLIC_CHAT ? (
                    ...
                    <MoreMenu dialogType={dialog.type} onInfoPress={() => navigation.navigate("DialogInfo", { dialog })} onLeavePress={leaveDialog} />
                )
        };
    };
    ...
    leaveDialog = () => {
        ...
        if (dialog.type === QB.chat.DIALOG_TYPE.CHAT) {
            ...
            const myName = currentUser.fullName || currentUser.login || currentUser.email;
            const body = `${myName} deixou a conversa`;
    ...
    render() {
        ...
        return (
            <KeyboardAvoidingView {...keyboardViewProps} style={{ flex: 1 }}>
