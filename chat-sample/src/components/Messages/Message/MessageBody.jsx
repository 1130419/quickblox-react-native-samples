...
export default class MessageBody extends React.Component {
    ...
    render() {
        ...
        const Content = () => {
            if (image) {
                return <RemoteImage onLongPress={onLongPress} resizeMode="cover" source={{ uri: imageUrl }} style={styles.attachment} />;
            } else if (video) {
                return <RemoteVideo onLongPress={onLongPress} resizeMode="cover" source={{ uri: imageUrl }} style={styles.attachment} />;
            } else {
                return (
                    <View pointerEvents="none">
