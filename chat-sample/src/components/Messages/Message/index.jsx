...
export default class Message extends React.Component {
    ...
    componentDidMount() {
        const { getPrivateUrl, imageUrl, message } = this.props;
    ...
    getDialogCircle = () => {
        ...
        const sentBy = sender ? sender.fullName || sender.login || sender.email : message.senderId.toString();
        ...
        return (
            <View style={styles.messageView}>
                ...
                <View style={styles.messageContent}>
                    <MessageMeta message={message} withMediaAttachment={withMediaAttachment} />
                    <LongPressMenu
    ...
    getMyMessage = () => {
        ...
        return (
            <View style={styles.myMessageView}>
                <View style={styles.messageContent}>
                    <MessageMeta message={message} messageIsMine={true} withMediaAttachment={withMediaAttachment} />
                    <LongPressMenu
                        dialogType={dialogType}
                        onDeliveredPress={this.onDeliveredPress}
                        onForwardPress={this.onForwardPress}
