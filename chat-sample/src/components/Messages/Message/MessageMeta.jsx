...
export default class MessageMeta extends React.PureComponent {
    ...
    getSentBy = () => {
        ...
        if (messageIsMine) {
            ...
            return sender ? sender.fullName || sender.login || sender.email : message.senderId.toString();
        }
    };
    ...
    getCheckMarks = () => {
        ...
        if (messageIsMine) {
            return delivered ? <Image source={CHECKMARK_DOUBLE} style={checkmarkStyle} /> : <Image source={CHECKMARK} style={checkmarkStyle} />;
        } else {
            return null;
        }
    };
    ...
    render() {
        ...
        return (
            <View style={metaViewStyle}>
                ...
                <View style={{ flex: 1 }} />
                {this.getCheckMarks()}
                <Text style={styles.messageSentAt}>{this.getSentAt()}</Text>
            </View>
        );
    }
}
