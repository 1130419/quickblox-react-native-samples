...
export default class RemoteImage extends React.PureComponent {
    ...
    render() {
        const videoProps = this.state.loaded
            ? this.props
            : {
                  ...this.props,
                  ref: "player",
        ...
        return (
            <View>
                ...
                {this.state.loaded ? null : (
                    ...
                    >
                        <Image pointerEvents="none" resizeMode="contain" source={VIDEO} style={{ height: 60, width: 82 }} />
                    </Animated.View>
                )}
                <TouchableOpacity onLongPress={this.onLongPress} onPress={this.play} style={styles.playBtn}>
