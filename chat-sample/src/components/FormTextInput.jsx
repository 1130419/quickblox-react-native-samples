...
import { LayoutAnimation, Platform, StyleSheet, Text, TextInput, UIManager } from "react-native";
...
export default class FormTextInput extends React.Component {
    ...
    shouldComponentUpdate(nextProps, nextState) {
        ...
        if (value !== nextProps.input.value || active !== nextProps.meta.active || error !== nextProps.meta.error || showHint !== nextState.showHint) {
            if (error !== nextProps.meta.error) {
                // should show or hide hint
    ...
    render() {
        ...
        return (
            <React.Fragment>
                ...
                />
                {this.state.showHint ? <Text style={styles.hint}>{this.state.hint}</Text> : null}
            </React.Fragment>
        );
    }
}
