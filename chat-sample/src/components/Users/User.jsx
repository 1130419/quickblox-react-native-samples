...
export default class User extends React.PureComponent {
    ...
    render() {
        ...
        const btnStyle = isSelected ? [styles.userBtn, styles.userBtnSelected] : styles.userBtn;
        ...
        return (
            <TouchableOpacity disabled={!selectable} onPress={this.onUserSelect} style={btnStyle}>
